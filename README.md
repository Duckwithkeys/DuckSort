...
- **Metadata Preservation**: On copy and move operations, DuckSort writes an `.xmp` sidecar beside every file (RAW, HEIF, JPEG) recording your custom tags and the photo's capture metadata (camera, lens, ISO, shutter, aperture, date).
